...
class Terkey:
  ...
  def banner(self):
      os.system('clear')
      print(f'{c}=================================='.center(50))
      print(f'{e}~~~~TERKEY = {c}[{d}Termux Key{c}]{e}~~~~'.center(68))
      print(f'{c}=================================='.center(50))
      print(f'{g}~~~~I’AM TUBASYA~~~~'.center(50))
      print(f'{c}=================================='.center(50))
  ...
  def about(self):
    ...
    A program from {g}Im tubasya{c} for you.
    ...
    {g}https://github.com/Imtubasya{c}
    My Channel Youtube
    {g}YT : I'am Tubasya{c}
    And Social Media :
    {g}FB : Tubagus Sya'bani{c}
    {g}IG : im.tubasya{c}
    """
    )
  ...
  def start(self):
    ...
    print(f"""
  {c}=================================
  {c} [{a}1{c}].{f} Use Default Keys
  {c}=================================
  {c} [{a}2{c}].{f} Custom Keys
  {c}=================================
  {c} [{a}3{c}].{f} About
  {c}=================================
    """
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan kunjungi '+a+'https://github.com/Imtubasya'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
