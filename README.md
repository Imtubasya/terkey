...
* `$ pkg install python`
* `$ pkg install git`
* `$ git clone https://github.com/Imtubasya/terkey`
* `$ cd terkey`
* `$ python terkey.py`
...
```pkg update && pkg upgrade;pkg install python git;git clone https://github.com/Imtubasya/terkey;cd terkey;python terkey.py```
...
> Thanks !
## Author
So many information about me in internet, just type ['I'am Tubasya'](https://github.com/Imtubasya) !
